...
/***/ "./src/index/form-validate/formControl.ts":
/*!************************************************!*\
  !*** ./src/index/form-validate/formControl.ts ***!
  \************************************************/
/*! no static exports found */
...
var submitEventFn = function (event) { return __awaiter(void 0, void 0, void 0, function () {
    var target, myHeaders, urlencoded, requestOptions, baseUrl;
    return __generator(this, function (_a) {
        ...
        if (shouldSendForm(target)) {
            ...
            baseUrl = "http://localhost:3003/api/avanceClient";
            fetch(baseUrl, requestOptions)
                .then(function (response) { return response.text(); })
                .then(function (result) { return console.log(result); })
                .catch(function (error) { return console.log('error de catch', error); });
        }
        return [2];
    });
}); };
...
var checkEmail = function (input) {
    if (!isEmail_1.default(input.value))
        showErrorMessage(input, 'Email inváido');
};
var checkEqualPasswords = function (password, password2) {
...
Object.defineProperty(exports, "__esModule", { value: true });
__webpack_require__(/*! ./form-validate/formControl */ "./src/index/form-validate/formControl.ts");
